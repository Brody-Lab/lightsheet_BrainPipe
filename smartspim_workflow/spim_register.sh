...
#SBATCH -t 600
#SBATCH -o /usr/people/abondy/logs/smartspim_reg_%j.out        # STDOUT #add _%a to see each array job
#SBATCH -e /usr/people/abondy/logs/smartspim_reg_%j.err        # STDERR #add _%a to see each array job
